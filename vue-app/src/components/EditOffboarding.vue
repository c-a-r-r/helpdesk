<template>
  <div class="edit-offboarding-page">
    <div class="page-header">
      <div class="header-content">
        <div class="header-text">
          <h1>Edit Offboarding</h1>
          <p>Update offboarding record details</p>
        </div>
    ...
    <div v-if="loading" class="loading-state">
      <p>Loading offboarding record...</p>
    </div>

    <div v-else-if="error" class="error-state">
      <p>Error loading record: {{ error }}</p>
      <button class="btn-outline" @click="fetchOffboardingRecord">Try Again</button>
    </div>
    ...
    <div v-else class="content-section">
      ...
      <div class="form-container">
        <form @submit.prevent="updateRecord" class="offboarding-form">
          <div class="form-grid">
            <!-- Status -->
  ...
  methods: {
    ...
    async fetchOffboardingRecord() {
      ...
      try {
        ...
        this.error = 'Failed to load offboarding record'
      } finally {
        this.loading = false
      }
    },
    ...
    async updateRecord() {
      ...
      try {
        ...
        await axios.put(
          `/api/v1/offboarding/${this.userId}?user_email=${encodeURIComponent(currentUserEmail)}`,
          this.formData
        )
        
        alert('Offboarding record updated successfully!')
        this.goBack()
      } catch (error) {
        console.error('Error updating offboarding record:', error)
        alert('Error updating record: ' + (error.response?.data?.detail || error.message))
      } finally {
        this.saving = false
      }
    },
